 ...
 * See:
 * - https://github.com/ArweaveTeam/arweave/blob/master/doc/path-manifest-schema.md
 * - https://github.com/stream-protocol/nft-marketplace/pull/859#pullrequestreview-805914075
 */
...
/**
 * Fetches the corresponding file pair and creates a data item if arweave bundle
