...
Stream NFT marketplace is a protocol built on top of Solana that allows:
...
You can check out our docs at https://docs.streamprotocol.app/nft-marketplace
...
- [@stream_protocol](https://twitter.com/stream_protocol) on Twitter
...
Stream Protocol NFTs can seamlessly create on-chain artist splits that remove the awkwardness out of collaboration.

Tag each collaborator, set custom percentages, and you’re off to the races. Each NFT can also be minted with configurable royalty payments that are then sent automatically back to the original creators whenever an artwork is resold on a Stream NFT marketplace in the future.
